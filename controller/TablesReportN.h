#ifndef _TABLES_REPORTN_H_
#define _TABLES_REPORTN_H_
...
void startTables(int n)
{
  ...
  int dataTime = 60000;  //duration of report data sensors (in miliseconds)
  ...
  timerTable[0].t0 =  t0; //
  timerTable[0].countdown = 65000; //repeat after 5 minutes
  ...
  timerTable[1].countdown = 65000; //repeat after 5 minutes
  ...
  for (int i = 1; i <= n; i++) {
    {      
      ...
      timerTableC[0][i].countdown = 65000; //repeat in 5 minutes
      ...
      timerTableC[1][i].countdown = 65000; //repeat in 5 minutes
      ...
      timerTableC[2][i].countdown = 65000; //repeat in 2 minutes
      ...
      for (int j = 2; j < SIZEOF_FLOW_TABLE; j++) {
