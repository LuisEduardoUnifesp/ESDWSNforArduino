...
void executeAction(uint16_t actionID, Package *netPacket)
{
  ...
  //printActionEntry(actionTable[actionID]);
  ...
  switch (actionTable[actionID].actionType)
  {
    case A_READ_SENSOR:
      ...
      for (int i = 0; i < npackages; i++) {
        ...
        netPacket2->setDestination(BROADCAST);
    ...
    case A_DISPLAY:
      ...
      Serial.print(F(":"));
      Serial.print(netPacket->getUserData(1));
      Serial.print(F(" from:"));
      Serial.print(netPacket->getFinalSource());
