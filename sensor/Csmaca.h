...
#define MINTIME 500 //Minimum time for CSMA draw
#define MINTIMEBTWSENDS 500 // Minimum time between sends
...
*/
enum typeStatus { RECEIVING, RX_READY, TRANSMITTING, BACKOFF, OFF };
